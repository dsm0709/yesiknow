...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_opt.setBackgroundResource(R.drawable.image_button_pressed);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				app.set_exchangeItem(app.get_optimalList().get_Item(position));
		...
		btn_map.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				if (app.get_optimalList() != null) {
					app.set_flag(true);
					Intent intent = new Intent();
					intent.putExtra("DATAFORMAP", "LIST");
					intent.setClass(MainActivity.this, MapList.class);
					startActivity(intent);
				}
			}
		});
		btn_ner.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent intent = new Intent();
				intent.setClass(MainActivity.this, NearList.class);
				finish();
				startActivity(intent);
	...
	public void refreshDataFromNet() {
		...
		if(app.per_date == 0)
			date = new Integer(date).toString();
		else 
			date = new Integer(app.per_date).toString();
		
		
		url = "192.168.2.1:5000/opt/";
		params = "lat=" + app.per_lat + "&lng=" + app.per_lng + "&consume="
				+ app.per_consume + "&sweet=" + app.per_sweet + "&sour="
				+ app.per_sour + "&spicy=" + app.per_spicy + "&salty="
				+ app.per_salty + "&order=" + app.opt_order + "&time="+ date;
		app.opt_order += 1;
...
//		Toast.makeText(MainActivity.this, "http://" + url + "?" + params,
...
//		Toast.LENGTH_LONG).show();
	...
	public void refreshDataFromAssets() {
		try {
			infoList = getInfoList();
			infoList.add_extralist(app.get_optimalList());
			app.set_optimalList(infoList);
			showList();
